 ...
 * @note   Modified the file by Xtra group to add parameter SKT for skew handling on MIC
 * 
 */
...
#define CACHE_LINE_TUPLES (CACHE_LINE_SIZE/(sizeof(tuple_t)))
